                                    ...
                                    <div className="flex items-center justify-center w-full h-full">
                                        ...
                                        >
                                            <img
                                                src={tvsLogo}
                                                alt="TVS Logo"
                                                className="max-h-[64px] w-auto object-contain drop-shadow-sm"
                                            />
                                        </motion.div>
                                    </div>
                                    <button
                                        onClick={() => setIsSidebarOpen(false)}
                                        className="absolute right-0 top-1/2 -translate-y-1/2 p-1.5 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-tvs-blue transition-colors"
                                    >
                                        <ChevronLeft size={20} />
                                    </button>
                                </motion.div>
